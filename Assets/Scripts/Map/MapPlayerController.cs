...
public class MapPlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (SceneController.Instance.m_PlayerMapPosition != Vector3.zero)
        {
            transform.position = SceneController.Instance.m_PlayerMapPosition;
            transform.rotation = SceneController.Instance.m_PlayerMapRotation;
        }
    }

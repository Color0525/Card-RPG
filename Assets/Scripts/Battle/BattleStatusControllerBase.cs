...
public abstract class BattleStatusControllerBase : MonoBehaviour
{
    ...
    [SerializeField] int m_newAP = 0;
    [SerializeField] int m_increaseAP = 100;
    ...
    //event Action m_beginAllieTurnEvent = default;
    //event Action m_endAllieTurnEvent = default;
    //スキル
    ...
    public int NewAP { get { return m_newAP; } }
    public int IncreaseAP { get { return m_increaseAP; } }
    ...
    {
        m_isActive = true;
        m_newAP = m_increaseAP;
        //BeginTurnイベントに登録した関数を呼び出す？
        Debug.Log(m_newAP);
    }
